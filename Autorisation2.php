                ...
                <div class="panel-body">
                    ...
                    <form action="Autorisation.php" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="">
                                        <option value="Autoriser" selected >Autoriser</option>
                                        <option value="Non Autoriser">Non Autoriser</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-warning" name="marquer-Autorisation2" >Marquer Autorisation</button>
                                </div>
                            </div>
                        </div>
                    </form>
