...
$query = "SELECT stagiaire.nom,stagiaire.prenom,autorisation.crn_horaire,autorisation.type_au,autorisation.date_aut,autorisation.formateur FROM autorisation,stagiaire where stagiaire.id=autorisation.id_stag and autorisation.type_au='Non Autoriser' and formateur='".$nom."' ";
...
$query2 = "SELECT stagiaire.nom,stagiaire.prenom,autorisation.crn_horaire,autorisation.type_au,autorisation.date_aut,autorisation.formateur FROM autorisation,stagiaire where stagiaire.id=autorisation.id_stag and autorisation.type_au='Autoriser' and  formateur='".$nom."' ";
...
<div class="row">
                    <div class="col-md-12">
        <div class="container">    <h4>Stagiaire Autoriser</h4>
